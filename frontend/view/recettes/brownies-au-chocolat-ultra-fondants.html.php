...
<head>
    ...
    <meta property="og:title" content="Recette de brownies au chocolat fondants" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Crimson+Text:wght@40[#2B1B12]&display=swap" rel="stylesheet" />
...
<body class="min-h-screen">
    ...
    <section class="px-4 mb-16 animate-fade-in delay-150">
        <div class="max-w-6xl mx-auto">
            <img src="../../frontend/assets/images/<?= htmlspecialchars(
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="order-first lg:order-last">
                    <img src="../../frontend/assets/images/Brownie Ingredients.jpg"
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-[#efe6de] border-2 border-[#2B1B12] rounded-2xl p-8">
                <div class="flex items-start gap-4">
                    <svg class="w-8 h-8 text-[#2B1B12] flex-shrink-0" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
        ...
        <div class="max-w-2xl mx-auto p-5 rounded-lg shadow-xl backdrop-blur-extra-light">
            <?php if (!empty($_SESSION["users_id"])): ?>
                ...
                <form action="?pg=recette&slug=<?= $recette->getRecipeSlug() ?>" method="POST" class="mb-6">
                    ...
                    <div class="mb-4">
                        <label for="comment_message" class="block text-gray-700 text-sm font-bold mb-2">Votre
                            commentaire:</label>
                        ...
                        <div id="star-rating" class="flex ml-2">
                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                <svg class="w-5 h-5 cursor-pointer star" data-rating="<?= $i ?>" fill="<?= $i <=
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.82 5.82 22 7 14.14 2 9.27l6.91-1.01L12 2z">
                                    </path>
                                </svg>
                            <?php endfor; ?>
                        </div>
            ...
            <?php else: ?>
                <div class="mb-6 text-center bg-gray-200 text-gray-800 border border-gray-400 rounded py-3 px-4">
                    Veuillez vous <a href="?pg=login"
                        class="underline text-gray-900 hover:text-black font-semibold">connecter</a> pour poster un
                    commentaire&nbsp;!
                </div>
            <?php endif; ?>
