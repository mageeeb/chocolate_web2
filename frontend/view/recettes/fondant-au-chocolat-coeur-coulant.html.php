            ...
            <div class="carousel" aria-label="Carrousel de photos">
                <div class="slides" id="slides">
                    <figure class="slide active">
                        <img src="https://images.unsplash.com/photo-1606313564200-e75d5f0166bd?q=80&w=1600&auto=format&fit=crop"
                            alt="Fondant prêt à servir" />
                        <figcaption class="cap">Fondant tout juste sorti du four.</figcaption>
                    </figure>
                    <figure class="slide">
                        <img src="https://images.unsplash.com/photo-1610450949065-1f2841536c88?q=80&w=1600&auto=format&fit=crop"
                            alt="Chocolat fondu" />
                        <figcaption class="cap">Chocolat noir fondu, brillant, parfum intense.</figcaption>
                    </figure>
                    <figure class="slide">
                        <img src="https://images.unsplash.com/photo-1541781408260-3c1b6a7a5f91?q=80&w=1600&auto=format&fit=crop"
                            alt="Pâte au chocolat" />
                        <figcaption class="cap">La pâte épaisse et satinée.</figcaption>
                    </figure>
                    <figure class="slide">
                        <img src="https://images.unsplash.com/photo-1601972599720-36938d4ecd31?q=80&w=1600&auto=format&fit=crop"
                            alt="Découpe du fondant" />
                        <figcaption class="cap">Découpe : le cœur coule doucement.</figcaption>
                    </figure>
                    <figure class="slide">
                        <img src="https://images.unsplash.com/photo-1603532648955-039310d9ed75?q=80&w=1600&auto=format&fit=crop"
                            alt="Fondant avec cacao" />
