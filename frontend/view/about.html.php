...
<body class="min-h-screen bg-[#f7efe6]">
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute top-20 left-10 w-2 h-2 rounded-full bg-rose/40 animate-float"
                style="animation-delay: 0s"></div>
            <div class="absolute top-40 right-20 w-3 h-3 rounded-full bg-accent/30 animate-float"
                style="animation-delay: 1s"></div>
            <div class="absolute top-60 left-1/4 w-1.5 h-1.5 rounded-full bg-chocolate-light/30 animate-float"
                style="animation-delay: 2s"></div>
            <div class="absolute bottom-40 right-1/3 w-2 h-2 rounded-full bg-rose/30 animate-float"
        ...
        <div class="container mx-auto px-6 pt-16 pb-8">
            ...
            <header class="text-center mb-16 animate-fade-in" style="animation-delay: 0.1s">
                <h1 class="font-display italic text-4xl md:text-5xl text-primary tracking-wide">
                    Chocolat Hub
                </h1>
            </header>

            <!-- Main Heading -->
            <div class="text-center max-w-3xl mx-auto mb-12 animate-fade-in" style="animation-delay: 0.3s">
                <h2 class="font-display text-4xl md:text-5xl lg:text-6xl text-foreground mb-6 leading-tight">
            ...
            <!-- Illustration -->
            <div class="flex justify-center mb-16 animate-fade-in" style="animation-delay: 0.5s">
                <img src="../../frontend/assets/images/chocolat-draw-removed.png"
    ...
    <section class="py-20" style="background-color: hsla(30, 20%, 95%, 0.5)">
        <div class="container mx-auto px-6">
            <h3 class="font-display text-3xl md:text-4xl text-center text-foreground mb-12 animate-fade-in"
                style="animation-delay: 0.7s">
                Notre histoire
            </h3>

            <div class="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto animate-fade-in" style="animation-delay: 0.9s">
                <div class="space-y-6">
            ...
            <!-- Values -->
            <div class="mt-20 grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto animate-fade-in"
                style="animation-delay: 1.1s">
                <div class="text-center">
                    <div class="w-12 h-12 mx-auto mb-4 rounded-full bg-rose-light flex items-center justify-center">
